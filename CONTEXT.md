...
| 8 | Embedded fast browser | RLI is a **client of GStack**. ⌘⇧B opens a pane that talks to GStack's localhost HTTP API. Shows screenshot stream + console/network log tail. Click screenshot → opens live page in user's real browser. RLI ships zero Chromium. |
...
- Bundling Chromium (GStack handles browser entirely)
